...
#define LCC_PROJECT_NAME "PROJECT_NAME"
...
enum LCC_API_HW_IDENTIFICATION_STRATEGY {
	 ...
	 *
	 * This strategy first checks the content of the environment variable `IDENTIFICATION_STRATEGY`. If the variable is
	 * defined it will use the strategy specified in there, if not defined it will try to detect which virtual
 ...
 */
#define LCC_BARE_TO_METAL_STRATEGIES \
	{ STRATEGY_DISK, STRATEGY_HOST_NAME, STRATEGY_NONE }
/**
 * List the strategies used when the software is executing in a virtual machine
 */
#define LCC_VM_STRATEGIES \
	{ STRATEGY_ETHERNET, STRATEGY_NONE }
#define LCC_LXC_STRATEGIES \
	{ STRATEGY_ETHERNET, STRATEGY_NONE }
#define LCC_DOCKER_STRATEGIES \
	{ STRATEGY_NONE }
/**
 * List the strategies used when it's detected an execution in the cloud
 */
#define LCC_CLOUD_STRATEGIES \
	{ STRATEGY_NONE }
