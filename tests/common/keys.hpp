#ifndef LCXX__TESTS_COMMON_KEYS_HPP__
#define LCXX__TESTS_COMMON_KEYS_HPP__

namespace lcxx::tests::keys {

    constexpr auto private_key_str = R"(
...
-----END RSA PRIVATE KEY-----
    ...
    constexpr auto public_key_str = R"(
-----BEGIN PUBLIC KEY-----
...
#endif  // LCXX__TESTS_COMMON_KEYS_HPP__